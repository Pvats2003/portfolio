  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-content items-center justify-between px-6 py-5 sm:px-10">
        <Link href="/" className="font-mono text-xs tracking-[0.15em] text-ink/90">
          PRIYANSHU VATS
        </Link>
        ...
        <nav className="hidden items-center gap-7 md:flex" aria-label="Primary">
          ...
          <button
            ...
            className="hidden items-center gap-1 font-mono text-[11px] text-faint transition-colors hover:text-muted lg:flex"
